            ...
            <div className="glass-card rounded-2xl p-4">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-400">Today • 45 min</p>
                </div>
                <div className="text-right">
                  <p className="text-sm font-semibold text-gym-orange">8 exercises</p>
                </div>
              </div>
            </div>
            ...
            <div className="glass-card rounded-2xl p-4">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-400">Yesterday • 5.2 km</p>
                </div>
                <div className="text-right">
            ...
            <div className="glass-card rounded-2xl p-4">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-400">2 days ago • 50 min</p>
                </div>
                <div className="text-right">
                  <p className="text-sm font-semibold text-gym-orange">6 exercises</p>
                </div>
              </div>
            </div>
          </div>
